  ...
  return (
    <section className="section" id='contact'>
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form action="https://getform.io/f/bgdpdmma" method='POST' className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label reveal-up">
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete='name' required placeholder='Ajith Malle' className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label reveal-up">
                            Email
                        </label>
                        <input type="text" name="email" id="email" autoComplete='email' required placeholder='ajith@example.com' className="text-field reveal-up" />
                    </div>
                </div>
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder='Hello!' required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                </div>
                <button type="submit" className='btn-primary h-9 flex items-center gap-2 px-4 rounded-xl font-medium text-sm ring-1 ring-inset ring-zinc-50/5 transition-[background-color] md:justify-self-end [&]:max-w-full w-full justify-center reveal-up'>Submit</button>
            </form>
        </div>
    </section>
  )
