        ...
        <div className='container'>
            <div className='bg-zinc-800/50 p-7 md:p-12 rounded-2xl reveal-up'>
                <p className='text-zinc-300 mb-4 md:mb-8 md:text-xl md:max-w-[60ch]'>
                    Hi! I’m <strong>Ajith Malle</strong>, a passionate <strong>Web Developer</strong> 
                    skilled in <strong>React.js</strong>, JavaScript, and responsive design. I love building websites 
                    that look stunning and perform smoothly. 
